...
export default function CastRoleBanner({ role, roleId, showId, dateTime, showTitle, troupeName, troupeConfirmed }: {
    role: Role | 'troupe',
    roleId: string | null,
    showTitle: string,
    showId: string,
            ...
            <div>
                ...
                {role === 'troupe' ? (
                    <TroupeCastConfirmationButtons
                        ...
                        showId={showId}
                        dateTime={dateTime}
                        initialConfirmed={troupeConfirmed ?? null}
                    />
                ) : null}
            </div>
