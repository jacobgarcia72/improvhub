...
export default function HamburgerMenu({ links }: { links: string[] }) {
    ...
    return <>
        {isOpen ? <>
            ...
            <div className="z-100 left-0 sm:left-30 hamburger-dropdown bg-[#556f8d] dark:bg-[#112247] border-[#556f8d] dark:border-[#112247] border-3 border-t-0 text-[1.1em] fixed top-11 flex flex-col max-h-[calc(100vh-44px)] flex-wrap">
                {links.map((link, i) => (
